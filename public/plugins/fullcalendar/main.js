...
var FullCalendar = (function (exports) {
    ...
    */
    var ScRoleController = /** @class */ (function () {
        function ScRoleController() {
        }
        ScRoleController.prototype.getMaxScrollTop = function () {
            return this.getScrollHeight() - this.getClientHeight();
        };
        ScRoleController.prototype.getMaxScrollLeft = function () {
            return this.getScrollWidth() - this.getClientWidth();
        };
        ScRoleController.prototype.canScrollVertically = function () {
            return this.getMaxScrollTop() > 0;
        };
        ScRoleController.prototype.canScrollHorizontally = function () {
            return this.getMaxScrollLeft() > 0;
        };
        ScRoleController.prototype.canScrollUp = function () {
            return this.getScrollTop() > 0;
        };
        ScRoleController.prototype.canScrollDown = function () {
            return this.getScrollTop() < this.getMaxScrollTop();
        };
        ScRoleController.prototype.canScrollLeft = function () {
            return this.getScrollLeft() > 0;
        };
        ScRoleController.prototype.canScrollRight = function () {
            return this.getScrollLeft() < this.getMaxScrollLeft();
        };
        return ScRoleController;
    }());
    var ElementScRoleController = /** @class */ (function (_super) {
        __extends(ElementScRoleController, _super);
        function ElementScRoleController(el) {
            var _this = _super.call(this) || this;
            _this.el = el;
            return _this;
        }
        ElementScRoleController.prototype.getScrollTop = function () {
            return this.el.scrollTop;
        };
        ElementScRoleController.prototype.getScrollLeft = function () {
            return this.el.scrollLeft;
        };
        ElementScRoleController.prototype.setScrollTop = function (top) {
            this.el.scrollTop = top;
        };
        ElementScRoleController.prototype.setScrollLeft = function (left) {
            this.el.scrollLeft = left;
        };
        ElementScRoleController.prototype.getScrollWidth = function () {
            return this.el.scrollWidth;
        };
        ElementScRoleController.prototype.getScrollHeight = function () {
            return this.el.scrollHeight;
        };
        ElementScRoleController.prototype.getClientHeight = function () {
            return this.el.clientHeight;
        };
        ElementScRoleController.prototype.getClientWidth = function () {
            return this.el.clientWidth;
        };
        return ElementScRoleController;
    }(ScRoleController));
    var WindowScRoleController = /** @class */ (function (_super) {
        __extends(WindowScRoleController, _super);
        function WindowScRoleController() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        WindowScRoleController.prototype.getScrollTop = function () {
            return window.pageYOffset;
        };
        WindowScRoleController.prototype.getScrollLeft = function () {
            return window.pageXOffset;
        };
        WindowScRoleController.prototype.setScrollTop = function (n) {
            window.scroll(window.pageXOffset, n);
        };
        WindowScRoleController.prototype.setScrollLeft = function (n) {
            window.scroll(n, window.pageYOffset);
        };
        WindowScRoleController.prototype.getScrollWidth = function () {
            return document.documentElement.scrollWidth;
        };
        WindowScRoleController.prototype.getScrollHeight = function () {
            return document.documentElement.scrollHeight;
        };
        WindowScRoleController.prototype.getClientHeight = function () {
            return document.documentElement.clientHeight;
        };
        WindowScRoleController.prototype.getClientWidth = function () {
            return document.documentElement.clientWidth;
        };
        return WindowScRoleController;
    }(ScRoleController));
    ...
    */
    ...
    /*
    Is a cache for a given element's scroll information (all the info that ScRoleController stores)
    ...
    */
    var ScrollGeomCache = /** @class */ (function (_super) {
        ...
        function ScrollGeomCache(scRoleController, doesListening) {
            var _this = _super.call(this) || this;
            _this.handleScroll = function () {
                _this.scrollTop = _this.scRoleController.getScrollTop();
                _this.scrollLeft = _this.scRoleController.getScrollLeft();
                _this.handleScrollChange();
            };
            _this.scRoleController = scRoleController;
            _this.doesListening = doesListening;
            _this.scrollTop = _this.origScrollTop = scRoleController.getScrollTop();
            _this.scrollLeft = _this.origScrollLeft = scRoleController.getScrollLeft();
            _this.scrollWidth = scRoleController.getScrollWidth();
            _this.scrollHeight = scRoleController.getScrollHeight();
            _this.clientWidth = scRoleController.getClientWidth();
            _this.clientHeight = scRoleController.getClientHeight();
        ...
        ScrollGeomCache.prototype.setScrollTop = function (top) {
            this.scRoleController.setScrollTop(top);
            if (!this.doesListening) {
        ...
        ScrollGeomCache.prototype.setScrollLeft = function (top) {
            this.scRoleController.setScrollLeft(top);
            if (!this.doesListening) {
                // we are not relying on the element to normalize out-of-bounds scroll values
                // so we need to sanitize ourselves
    ...
    var ElementScrollGeomCache = /** @class */ (function (_super) {
        ...
        function ElementScrollGeomCache(el, doesListening) {
            return _super.call(this, new ElementScRoleController(el), doesListening) || this;
        }
        ElementScrollGeomCache.prototype.getEventTarget = function () {
            return this.scRoleController.el;
        };
        ElementScrollGeomCache.prototype.computeClientRect = function () {
            return computeInnerRect(this.scRoleController.el);
        };
    ...
    var WindowScrollGeomCache = /** @class */ (function (_super) {
        ...
        function WindowScrollGeomCache(doesListening) {
            return _super.call(this, new WindowScRoleController(), doesListening) || this;
        }
    ...
    */
    ...
    exports.ElementScRoleController = ElementScRoleController;
    ...
    exports.ScRoleController = ScRoleController;
    ...
    exports.WindowScRoleController = WindowScRoleController;
